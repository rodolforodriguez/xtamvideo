...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-tools pull-{{ trans('crudbooster.right') }}" style="position: relative;margin-top: -5px;margin-right: -10px">
            ...
            $xtamvideo = "/xtamvideo/public/admin/parameter";
            $xtam = "/xtam/public/admin/parameter";
            if ($url === $xtamvideo || $url === $xtam) {
                ?>
                <div class="box-header" style="display: none;"></div>
                <script>
                        console.log('<?php echo ($url); ?>');
                        console.log('<?php echo ($parameter); ?>');
                    </script>
                <?php
                } else {
                    ?>
