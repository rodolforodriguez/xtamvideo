    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.connectedSortable').each(function () {
                ...
                $.get("<?php echo e(CRUDBooster::mainpath('list-component')); ?>/" + id_cms_statistics + "/" + areaname, function (response) {
                    if (response.components) {
                        ...
                        $.each(response.components, function (i, obj) {
                            ...
                            $.get("<?php echo e(CRUDBooster::mainpath('view-component')); ?>/" + obj.componentID, function (view) {
