...
<header class="main-header">
    ...
    switch ($id_profile) {
        case 4:
            ?>
    <a class="logo font-xtam" href="<?php echo e(CRUDBooster::adminPath()); ?>">
        <img src="<?php echo e(URL::to('/')); ?>/includes/img/Xtam_v_a.png">
    </a>
    <?php
        break;
    case 5:
        ?>
    <a class="logo font-xtam" href="<?php echo e(CRUDBooster::adminPath()); ?>">
        <img src="<?php echo e(URL::to('/')); ?>/includes/img/Xtam_Alarmas.png">
    </a>
    <?php
        break;
    ...
    case 6:
        ?>
    <a class="logo font-xtam" href="<?php echo e(CRUDBooster::adminPath()); ?>">
        <img src="<?php echo e(URL::to('/')); ?>/includes/img/Xtam_Video.png">
    </a>
    <?php
        break;
    ...
    default;
        ?>
    <a class="logo font-xtam" href="<?php echo e(CRUDBooster::adminPath()); ?>"></a>
    <?php
}
?>
    <!-- Header Navbar -->
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-<?php echo e(trans('crudbooster.left')); ?>">
                                <a href="<?php echo e(route('AdminCmsUsersControllerGetProfile')); ?>" class="btn btn-default btn-flat"><i class='fa fa-user'></i> <?php echo e(trans("crudbooster.label_button_profile")); ?></a>
                            </div>
