...
<head>
    ...
    <!-- load css -->
    <style type="text/css">
        <?php if ($style_css) : ?><?php echo $style_css; ?><?php endif; ?>
    </style>
    <?php if ($load_css) : ?>
    <?php $__currentLoopData = $load_css;
        $__env->addLoop($__currentLoopData);
        foreach ($__currentLoopData as $css) : $__env->incrementLoopIndices();
...
<body class="<?php echo (Session::get('theme_color')) ?: 'skin-red';
                    echo ' sidebar-collapse';
                    echo config('crudbooster.ADMIN_LAYOUT'); ?> <?php echo e(($sidebar_mode) ?: ''); ?>">
    <?php
    } else {
        ?>
    ...
    <body class="<?php echo (Session::get('theme_color')) ?: 'skin-red';
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <h1>
                        ...
                        <?php $__currentLoopData = $index_button;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $ib) : $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                        <a href='<?php echo e($ib["url"]); ?>' id='<?php echo e(str_slug($ib["label"])); ?>' class='btn <?php echo e(($ib['color']) ? 'btn-' . $ib['color'] : 'btn-primary'); ?> btn-sm' <?php if ($ib['onClick']) : ?> onClick='return <?php echo e($ib["onClick"]); ?>' <?php endif; ?> <?php if ($ib['onMouseOver']) : ?> onMouseOver='return <?php echo e($ib["onMouseOver"]); ?>' <?php endif; ?> <?php if ($ib['onMouseOut']) : ?> onMouseOut='return <?php echo e($ib["onMouseOut"]); ?>' <?php endif; ?> <?php if ($ib['onKeyDown']) : ?> onKeyDown='return <?php echo e($ib["onKeyDown"]); ?>' <?php endif; ?> <?php if ($ib['onLoad']) : ?> onLoad='return <?php echo e($ib["onLoad"]); ?>' <?php endif; ?>>
                ...
                <section id='content_section' class="content">
                    ...
                    <?php if (@$alerts) : ?>
                    <?php $__currentLoopData = @$alerts;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $alert) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
        ...
        <!-- load js -->
        <?php if ($load_js) : ?>
        <?php $__currentLoopData = $load_js;
            $__env->addLoop($__currentLoopData);
            foreach ($__currentLoopData as $js) : $__env->incrementLoopIndices();
                $loop = $__env->getLastLoop(); ?>
