...
//>>built
define("require exports ../../../core/tsSupport/declareExtendsHelper ../../../core/tsSupport/decorateHelper ../../../core/Accessor ../../../core/Evented ../../../core/accessorSupport/decorators ../../../views/2d/draw/support/Box ../../../views/2d/draw/support/GraphicMover ../../../views/2d/draw/support/Reshape".split(
    " "
), function(m, n, g, c, h, k, b, e, l, f) {
    return (function(d) {
        function a() {
        ...
        g(a, d);
        Object.defineProperty(a.prototype, "tool", {
            get: function() {
                return this.activeComponent instanceof l
                    ? "move"
                    : this.activeComponent instanceof e
                    ? "transform"
                    : this.activeComponent instanceof f
                    ? "reshape"
                    : null;
            },
            enumerable: !0,
        ...
        a.prototype.addToHistory = function(a) {
            this.history.redo = [];
            this.history.undo.push(a);
        };
        a.prototype.resetHistory = function() {
            this.history.redo = [];
            this.history.undo = [];
        };
        a.prototype.canUndo = function() {
            return 0 < this.history.undo.length;
        };
        a.prototype.canRedo = function() {
            return 0 < this.history.redo.length;
        };
        ...
        a.prototype.refreshComponent = function() {
            var a = this.activeComponent;
        ...
        c([b.property()], a.prototype, "history", void 0);
        c(
            [b.property({ dependsOn: ["activeComponent"] })],
            a.prototype,
            "tool",
            null
        );
        ...
        c([b.property()], a.prototype, "refreshComponent", null);
        ...
        return (a = c(
            [b.subclass("esri.widgets.Sketch.support.OperationHandle")],
            a
        ));
    })(b.declared(h, k));
});
