...
define("require exports ../../core/tsSupport/assignHelper ../../core/tsSupport/declareExtendsHelper ../../core/tsSupport/decorateHelper ../../geometry ../../Graphic ../../core/Accessor ../../core/Collection ../../core/Error ../../core/Evented ../../core/Handles ../../core/Logger ../../core/watchUtils ../../core/accessorSupport/decorators ../../geometry/support/coordsUtils ../../geometry/support/graphicsUtils ../../layers/GraphicsLayer ../../symbols/SimpleFillSymbol ../../symbols/SimpleLineSymbol ../../symbols/SimpleMarkerSymbol ../../views/2d/draw/Draw ../../views/2d/draw/support/Box ../../views/2d/draw/support/GraphicMover ../../views/2d/draw/support/Reshape ./support/OperationHandle ./support/sketchUtils".split(
    ...
    return (function(H) {
        function e(b) {
            ...
            b.activeFillSymbol = new A({
                style: "solid",
                color: [150, 150, 150, 0.2],
                outline: { color: [0, 0, 0, 0] }
            });
            b.activeLineSymbol = new B({
                color: [12, 207, 255, 1],
                width: 2,
                style: "dash"
            });
            b.activePointSymbol = new x({
                style: "circle",
                size: 6,
                color: [12, 207, 255],
        ...
        e.prototype.initialize = function() {
            ...
            this.view &&
                this.view.ready &&
                (this._setUpViewReadyHandle(),
                (this._draw = new G({ view: this.view })));
            this._handles.add([
                E.pausable(this, "view.ready", function(d) {
                    b.reset();
                    d
                        ? (b._setUpViewReadyHandle(),
                          (b._draw = new G({ view: b.view })))
                        : (b._viewHandles.removeAll(),
                          b._draw && b._draw.destroy(),
                          (b._draw = null));
                }),
                E.pausable(this, "layer", function() {
                    return b._reset();
                })
            ]);
        };
        ...
        Object.defineProperty(e.prototype, "activeTool", {
            get: function() {
                return this._operationHandle && this._operationHandle.tool
                    ? this._operationHandle.tool
                    : null;
            },
            enumerable: !0,
            configurable: !0
        ...
        Object.defineProperty(e.prototype, "view", {
            ...
            set: function(b) {
                b && "2d" !== b.type
                    ? this._logError(
                          "sketch:sceneview",
                          "Property 'view' must be of type 'MapView' on SketchViewModel."
                      )
                    : this._set("view", b);
            },
            enumerable: !0,
        ...
        e.prototype.update = function(b, d) {
            ...
            if (b)
                if ("disabled" === this.state)
                    ...
                    if (!c || !c.length)
                        this._logError(
                            "sketch:missing-graphics",
                            "Missing parameter 'graphics'."
                        );
                    else if (
                        !c.some(function(b) {
                            if (b.layer !== a.layer)
                            ...
                            if (!b.geometry)
                                return (
                                    a._logError(
                                        "sketch:geometry-invalid-type",
                                        "Parameter 'graphics' contains one or more Graphics with an unsupported Geometry type."
                                    ),
                                    !0
                                );
                        })
                    ) {
                        var n = this._setupUpdateOperation(
                            c,
        ...
        e.prototype.canUndo = function() {
            return !(
                !this._operationHandle || !this._operationHandle.canUndo()
            );
        };
        e.prototype.canRedo = function() {
            return !(
                !this._operationHandle || !this._operationHandle.canRedo()
            );
        };
        e.prototype.toggleUpdateTool = function() {
        ...
        e.prototype._setUpViewReadyHandle = function() {
            ...
            this._viewHandles.add([
                this.view.on("click", function(d) {
                    "disabled" !== b.state &&
                        b.updateOnGraphicClick &&
                        b.view.hitTest(d).then(function(a) {
                            a = a.results;
                            a.length
                                ? a.some(function(a) {
                                      if (a.graphic) {
                                          a = a.graphic;
                                          if (-1 < b.updateGraphics.indexOf(a))
                                              return !0;
                                          if (a.layer === b.layer)
                                              return (
                                                  b.update(
        ...
        e.prototype._setupCreatePointOperation = function(b, d) {
            ...
            var c = [
                    d.on("cursor-update", function(b) {
                        return a._displayCrosshairCursor();
                    }),
                    d.on("draw-complete", function(b) {
                        b = b.coordinates;
            ...
            var a = this,
                ...
                k = [
                    ...
                    c.on("vertex-remove", function(c) {
                        ...
                        a._emitCreateEvent({
                            ...
                            state: "active",
                            tool: b,
                            toolEventInfo: { removed: d, type: h }
                        });
                    }),
                    ...
                    c.on("cursor-update", function(a) {
                        n = a;
                    }),
                    c.on("draw-complete", function(b) {
                        b = b.vertices.slice(0);
                        (b = r.createMultipoint(b, a.view))
                            ? (a.createGraphic &&
                                  (a.createGraphic.geometry = b),
                              e && e.complete())
                            : e && e.cancel();
                    }),
                ...
                l = [
                    ...
                    this.view.on("key-down", function(b) {
                        return a._getCommonUpdateOperationKeyDownHandlers(e, b);
                    })
                ];
            return e;
        };
        e.prototype._setupCreatePolyOperation = function(b, d) {
            ...
            "polyline" === b
                ? (c = this._draw.create(b, d))
                : "polygon" === b && (c = this._draw.create(b, d));
            var e = new v.Point(),
                g = null,
                k = !1,
                l = [
                    ...
                    c.on("draw-complete", function(c) {
                        ...
                        var m = null;
                        "polyline" === b
                            ? (m = r.createPolyline([c], a.view))
                            : "polygon" === b &&
                              (m = r.createPolygon([c], a.view));
                        m
                            ? ((a.createGraphic.geometry = m),
                              h && h.complete())
                            : h && h.cancel();
                    }),
                    c.on("undo", function(c) {
                        ...
                        a._resetCreateOperationGraphics();
                        c.length &&
                            (k && a._snapLastVertexToAxis(c),
                            a._drawVertexGraphics(b, c, { userClicked: h }));
                    }),
                ...
                f = [
                    ...
                    this.view.on("key-down", function(d) {
                        ...
                        "Control" !== d.key || k
                            ? "z" === d.key && h && h.canUndo()
                                ? (d.stopPropagation(), h.undo())
                                : "r" === d.key && h && h.canRedo()
                                ? (d.stopPropagation(), h.redo())
                                : "Escape" === d.key && h && h.cancel()
                            : ((k = !0),
                              !e && a._snapLastVertexToAxis(m),
                              a._drawVertexGraphics(b, m, { userClicked: e }));
                    }),
                ...
                f.concat([
                    this.view.on("pointer-down", function(b) {
                        a.view.hitTest(b).then(function(c) {
                            ...
                            c.length &&
                                c[0].graphic &&
                                0 === a._vertexGraphics.indexOf(c[0].graphic) &&
                                b.stopPropagation();
                        });
                    }),
                    this.view.on("click", function(b) {
                        a.view.hitTest(b).then(function(h) {
                            ...
                            h.length &&
                                h[0].graphic &&
                                0 === a._vertexGraphics.indexOf(h[0].graphic) &&
                                2 < a._vertexGraphics.length &&
                                (b.stopPropagation(),
                                g &&
                                    "cursor-update" === g.type &&
                                    c.vertices.pop(),
                                c.complete());
                        });
                    })
                ...
                k = [
                    c.on("vertex-add", function(c) {
                        var h = c.type,
                            d = c.vertices;
                        c = d[c.vertexIndex];
                        a._drawSegmentGraphic(b, d, {
                            centered: g,
                            constrained: e
                        });
                        a._emitCreateEvent({
                            graphic: a.createGraphic,
                            state: 1 === d.length ? "start" : "active",
                            tool: b,
                            toolEventInfo: { added: c, type: h }
                        });
                    }),
                    c.on("cursor-update", function(c) {
                        var h = c.type;
                    ...
                    c.on("draw-complete", function(b) {
                        ...
                        1 === b.length
                            ? ((c = b[0]),
                              b.push([
                                  c[0] +
                                      a._defaultSegmentOffset *
                                          a.view.resolution,
                                  c[1]
                              ]),
                              (c = r.createCircle(b, a.view, !0)))
                            : (c = e
                                  ? r.createEllipse(b, a.view, g)
                                  : r.createCircle(b, a.view, g));
                        a.createGraphic
                            ? (a.createGraphic.geometry = c)
                            : (a._removeCreateGraphic(),
                              a._set(
                                  "createGraphic",
                                  new u(c, a.polygonSymbol)
                              ));
                        f && f.complete();
                    })
                ],
                l = [
                    ...
                    this.view.on("key-down", function(d) {
                        "Control" !== d.key || e
                            ? "Alt" === d.key && g
                                ? ((g = !1),
                                  a._drawSegmentGraphic(b, c.vertices, {
                                      centered: g,
                                      constrained: e
                                  }))
                                : "Escape" === d.key && f && f.cancel()
                            : ((e = !0),
                              a._drawSegmentGraphic(b, c.vertices, {
                                  centered: g,
                                  constrained: e
                    ...
                    this.view.on("key-up", function(d) {
                        "Control" === d.key
                            ? ((e = !1),
                              a._drawSegmentGraphic(b, c.vertices, {
                                  centered: g,
                ...
                k = [
                    c.on("vertex-add", function(c) {
                        var d = c.type,
                            h = c.vertices;
                        c = h[c.vertexIndex];
                        a._drawSegmentGraphic(b, h, {
                            centered: g,
                            constrained: e
                        });
                        a._emitCreateEvent({
                            graphic: a.createGraphic,
                            state: 1 === h.length ? "start" : "active",
                            tool: b,
                            toolEventInfo: { added: c, type: d }
                        });
                    }),
                    c.on("cursor-update", function(c) {
                        var d = c.type;
                    ...
                    c.on("draw-complete", function(c) {
                        ...
                        b = e
                            ? r.createSquare(c, a.view, g)
                            : r.createRectangle(c, a.view, g);
                        a.createGraphic
                            ? (a.createGraphic.geometry = b)
                            : (a._removeCreateGraphic(),
                              a._set(
                                  "createGraphic",
                                  new u(b, a.polygonSymbol)
                              ));
                        f && f.complete();
                    })
                ],
        ...
        e.prototype._setupUpdateOperation = function(b, d) {
            var a =
                d.tool ||
                this.defaultUpdateOptions.tool ||
                this._defaultUpdateTool;
            if (1 < b.length && "reshape" === a)
                this._logError(
                    "sketch:reshape-multiple",
                    "Reshape operation does not support multiple graphics."
                );
            else {
                if ("move" === a) return this._setupMoveOperation(b, d);
                if (1 < b.length)
                    return this._setupTransformOrReshapeOperation(b, a, d);
                if (1 === b.length) {
                    var c = b[0].geometry.type || null;
                    if ("point" === c || "multipoint" === c)
                        return this._setupMoveOperation(b, d);
                    if ("transform" === a || "reshape" === a)
                        return this._setupTransformOrReshapeOperation(b, a, d);
                }
                return null;
            }
        ...
        e.prototype._setupMoveOperation = function(b, d) {
            ...
            var g = [
                            ...
                            if (l)
                                if (((b = b.results), b.length)) {
                                    ...
                                    b.some(function(c) {
                                        if (c.graphic) {
                                            c = c.graphic;
                                            if (d && c.layer === a.layer)
                                                return (
                                                    -1 ===
                                                    a.updateGraphics.indexOf(c)
                                                        ? l.addToSelection(c)
                    ...
                    this.view.on("key-down", function(c) {
                        return a._getCommonUpdateOperationKeyDownHandlers(l, c);
                    }),
                    this.view.on("key-down", function(a) {
                        "Control" !== a.key ||
                            e ||
                            ((e = !0), (k.enableMoveAllGraphics = !e));
                    }),
                    this.view.on("key-up", function(a) {
                        "Control" === a.key &&
                            ((e = !1), (k.enableMoveAllGraphics = !e));
                    })
                ],
                ...
                l = new y({
                    ...
                    onEnd: function() {
                        ...
                        a.updateGraphics.forEach(function(a, b) {
                            a.symbol = c[b].symbol;
                        });
                    },
                    undo: function() {
                    ...
                    removeFromSelection: function(b) {
                        ...
                        if (0 === a.updateGraphics.length)
                            return l.canUndo() ? l.complete() : l.cancel(), !0;
                        k.graphics = a.updateGraphics.toArray();
                    }
                }),
                f = [
                    k.on("graphic-move-start", function(a) {
                        return l.addToHistory({
                            updates: [a.graphic.geometry]
                        });
                    })
                ];
            return l;
        ...
        e.prototype._setupTransformOrReshapeOperation = function(b, d, a) {
            ...
            var l = [
                                ...
                                b.some(function(a) {
                                    if (a.graphic) {
                                        ...
                                        if (
                                            ...
                                            return f.addToSelection(a), !0;
                                        if (d instanceof z && d.isUIGraphic(a))
                                            return (
                                                !1 !== e &&
                                                    1 ===
                                                        c.updateGraphics
                                                            .length &&
                                                    ("extent" ===
                                                    c.updateGraphics.getItemAt(
                                                        0
                                                    ).geometry.type
                                                        ? c._logError(
                                                              "sketch:extent",
                                                              "The 'reshape' tool does not support Graphics with geometry type of Extent."
                                                          )
                                                        : f.toggleTool()),
                                                !0
                                            );
                ...
                this.view.on("key-down", function(a) {
                    return c._getCommonUpdateOperationKeyDownHandlers(f, a);
                }),
                this.view.on("key-down", function(a) {
                    "Control" === a.key &&
                        !k &&
                        ...
                        (a = f.activeComponent),
                        a instanceof z &&
                            (a.preserveAspectRatio = !a.preserveAspectRatio));
                }),
                this.view.on("key-up", function(a) {
                    "Control" === a.key &&
                        f &&
            ...
            var f = new y({
                    ...
                    onEnd: function() {
                        ...
                        c.updateGraphics.forEach(function(a, c) {
                            g[c] && g[c].symbol && (a.symbol = g[c].symbol);
                        });
                    },
                    undo: function() {
                        if (f.canUndo()) {
                            ...
                            f.history.redo.push({
                                updates: w.getGeometries(
                                    c.updateGraphics.toArray()
                                )
                            });
                            c.updateGraphics.forEach(function(c, b) {
                                c.geometry = a[b];
                            });
                            f.refreshComponent();
                            c._emitUndoEvent({
                                graphics: c.updateGraphics.toArray(),
                                tool: f.tool
                            });
                        }
                    },
                    ...
                    toggleTool: function() {
                        1 < c.updateGraphics.length ||
                            (f.activeComponent.destroy(),
                            "transform" === f.tool
                                ? (f.activeComponent = c._getReshape(b, a))
                                : "reshape" === f.tool &&
                                  (f.activeComponent = c._getBox(b, a)),
                            f.activeComponent &&
                                (h.forEach(function(a) {
                                    return a.remove();
                                }),
                                (h = c._getHandlesForComponent(f))));
                    }
                }),
        ...
        e.prototype._getGraphicMover = function(b, d) {
            ...
            return new P(
                t(
                    {},
                    { enableMoveAllGraphics: !1 !== d.enableMidpoints },
                    {
                        graphics: b,
                        view: this.view,
                        callbacks: {
                            ...
                            onGraphicPointerOver: function(b) {
                                return a._displayPointerCursor();
                            },
                            onGraphicPointerOut: function(b) {
                                return a._displayDefaultCursor();
                            }
                        }
                    }
                )
        ...
        e.prototype._getBox = function(b, d) {
            ...
            return new z(
                t(
                    ...
                    {
                        graphics: b,
                        enableRotation: !1 !== d.enableRotation,
                        enableScaling: !1 !== d.enableScaling,
        ...
        e.prototype._getReshape = function(b, d) {
            ...
            return new C(
                t(
                    {},
                    { enableMidpoints: !1 !== d.enableMidpoints },
                    {
                        graphic: b[0],
                        layer: this._layer,
                        view: this.view,
                        callbacks: {
                            onReshapeStart: function(b) {
                                return a._emitUpdateEvent({
                                    graphics: a.updateGraphics.toArray(),
                                    state: "active",
                                    tool: a.activeTool,
                            ...
                            onVertexAdd: function(b) {
                                var c = b.type;
                                b = b.added.map(function(a) {
                                    return F.geometryToCoordinates(a.geometry);
                                });
                                a._emitUpdateEvent({
                                    graphics: a.updateGraphics.toArray(),
                                    state: "active",
                                    tool: a.activeTool,
                                    toolEventInfo: { added: b, type: c }
                                });
                            },
                            onVertexRemove: function(b) {
                                var c = b.type;
                                b = b.removed.map(function(a) {
                                    return F.geometryToCoordinates(a.geometry);
                                });
                                a._emitUpdateEvent({
                                    graphics: a.updateGraphics.toArray(),
                                    state: "active",
                                    tool: a.activeTool,
                                    toolEventInfo: { removed: b, type: c }
                                });
                            }
                        }
                    }
        ...
        e.prototype._getHandlesForComponent = function(b) {
            ...
            if (d instanceof z)
                return [
                    d.on("move-start", function(a) {
                        return b.addToHistory({
                            updates: w.getGeometries(a.graphics)
                        });
                    }),
                    d.on("rotate-start", function(a) {
                        return b.addToHistory({
                            updates: w.getGeometries(a.graphics)
                        });
                    }),
                    d.on("scale-start", function(a) {
                        return b.addToHistory({
                            updates: w.getGeometries(a.graphics)
                        });
                    })
            ...
            if (d instanceof C)
                return [
                    d.on("move-start", function(a) {
                        return b.addToHistory({ updates: [a.mover.geometry] });
                    }),
                    d.on("reshape-start", function(a) {
                        return b.addToHistory({
                            updates: [a.graphic.geometry]
                        });
                    }),
                    d.on("vertex-add", function(a) {
                        return b.addToHistory({
                            updates: [a.oldGraphic.geometry]
                        });
                    }),
                    d.on("vertex-remove", function(a) {
                        return b.addToHistory({
                            updates: [a.oldGraphic.geometry]
                        });
                    })
        ...
        e.prototype._getCommonUpdateOperationKeyDownHandlers = function(b, d) {
            if (b) {
                var a = d.key;
                "z" === a && b.canUndo()
                    ? (d.stopPropagation(), b.undo())
                    : "r" === a && b.canRedo()
                    ? (d.stopPropagation(), b.redo())
                    : "Escape" === a &&
                      (b.canUndo() ? b.complete() : b.cancel());
            }
        };
        e.prototype._getCreateSymbol = function(b, d) {
            b = b.type || null;
            return "point" === b || "multipoint" === b
                ? d
                    ? this.activePointSymbol
                    : this.pointSymbol
                : "polyline" === b
                ? d
                    ? this.activeLineSymbol
                    : this.polylineSymbol
                : "polygon" === b
                ? d
        ...
        e.prototype._getUpdateSymbol = function(b) {
            b = b.type || null;
            return "point" === b || "multipoint" === b
                ? this.updatePointSymbol
                : "polyline" === b
                ? this.updatePolylineSymbol
                : "polygon" === b || "extent" === b
                ? this.updatePolygonSymbol
                : null;
        };
        e.prototype._drawMultipointGraphic = function(b, d) {
            ...
            !d && 1 < b.length
                ? ((a = b.slice(0)),
                  a.pop(),
                  (a = r.createMultipoint(a, this.view)))
                : (a = r.createMultipoint(b, this.view));
            this.createGraphic
                ? (this.createGraphic.geometry = a)
                : this._set("createGraphic", new u(a, this.pointSymbol));
            d && 1 === b.length && this._layer.add(this.createGraphic);
        };
        e.prototype._drawVertexGraphics = function(b, d, a) {
            a = !(!a || !a.userClicked);
            var c = "polygon" === b,
            ...
            if (1 === d.length) {
                ...
                var k = g[1],
                    ...
                    c = c
                        ? r.createPolygon([d], this.view)
                        : r.createPolyline([d], this.view);
                this._vertexGraphics.length
                    ? (this._vertexGraphics[0].geometry = k)
                    : this._vertexGraphics.push(
                          new u(k, this.activePointSymbol)
                      );
                this.createGraphic
                    ? (this.createGraphic.geometry = c)
                    : this._set("createGraphic", new u(c, e));
                a && this._layer.add(this._vertexGraphics[0]);
            } else if (2 === d.length)
                (e = d[1]),
                    (b = e[0]),
                    (k = e[1]),
                    (g = new v.Point(b, k, this.view.spatialReference)),
                    (b = this._getCreateSymbol(g, !0)),
                    (e = r.createPolyline([d], this.view)),
                    (c = c
                        ? r.createPolygon([d], this.view)
                        : r.createPolyline([d], this.view)),
                    this._vertexGraphics.length ||
                        ...
                        (d = new u(k, b)),
                        this._vertexGraphics.push(d)),
                    1 === this._vertexGraphics.length
                        ? ((d = this._vertexGraphics[0]),
                          (g = new u(g, b)),
                          this._removeLineGraphic(),
                          this._removeActiveFillGraphic(),
                          this._vertexGraphics.push(g),
                          this._layer.remove(d),
                          this._layer.add(d))
                        : (this._vertexGraphics[1].geometry = g),
                    this._showActiveLineGraphic(e),
                    (d = this._vertexGraphics[0]),
                    a &&
                        ((this._activeLineGraphic.symbol = this.polylineSymbol),
                        (d.symbol = this.pointSymbol),
                        this._layer.add(this._vertexGraphics[1])),
                    this.createGraphic
                        ? (this.createGraphic.geometry = c)
                        : this._set(
                              "createGraphic",
                              new u(c, this.polygonSymbol)
                          ),
                    this._layer.remove(d),
                    this._layer.add(d);
            else if (2 < d.length) {
                ...
                for (g in b)
                    (b = this._vertexGraphics[g])
                        ? (b.symbol = this.pointSymbol)
                        : ((k = d[g]),
                          (b = k[0]),
                          (k = k[1]),
                          this._showVertexGraphic(
                              new v.Point(b, k, this.view.spatialReference)
                          ));
                a
                    ? ((this._activeLineGraphic.symbol = this.polylineSymbol),
                      (a = d[d.length - 1]),
                    ...
                    : ((this._activeLineGraphic.symbol = this.activeLineSymbol),
                      (this._vertexGraphics[
                          this._vertexGraphics.length - 1
                      ].symbol = this.activePointSymbol));
                this.createGraphic
                    ? (this.createGraphic.geometry = c)
                    : (this._removeCreateGraphic(),
                      this._set("createGraphic", new u(c, e)));
                a = 0;
                for (c = this._vertexGraphics; a < c.length; a++)
                    (d = c[a]), this._layer.remove(d), this._layer.add(d);
            }
        };
        e.prototype._drawSegmentGraphic = function(b, d, a) {
            if (d.length) {
                ...
                var e = null;
                1 === d.length
                    ? ((e = r.createPolygon([d], this.view)),
                      this._removeCenterIndicatorGraphic())
                    : ("rectangle" === b
                          ? (e = a
                                ? r.createSquare(d, this.view, c)
                                : r.createRectangle(d, this.view, c))
                          : "circle" === b &&
                            (e = a
                                ? r.createEllipse(d, this.view, c)
                                : r.createCircle(d, this.view, c)),
                      e.extent &&
                          e.extent.center &&
                          this._showCenterIndicatorGraphic(e.extent.center));
                this.createGraphic
                    ? (this.createGraphic.geometry = e)
                    : (this._removeCreateGraphic(),
                      this._set("createGraphic", new u(e, this.polygonSymbol)),
                      this._layer.add(this.createGraphic));
            }
        };
        e.prototype._showCenterIndicatorGraphic = function(b) {
            this._centerIndicatorGraphic
                ? (this._centerIndicatorGraphic.geometry = b)
                : ((this._centerIndicatorGraphic = new u(
                      b,
                      this._centerSymbol
                  )),
                  this._layer.add(this._centerIndicatorGraphic));
        };
        e.prototype._removeCenterIndicatorGraphic = function() {
            this._centerIndicatorGraphic &&
                (this._layer.remove(this._centerIndicatorGraphic),
                this._centerIndicatorGraphic.destroy(),
                (this._centerIndicatorGraphic = null));
        };
        e.prototype._showActiveLineGraphic = function(b) {
            this._activeLineGraphic
                ? (this._activeLineGraphic.geometry = b)
                : ((this._activeLineGraphic = new u(b, this.activeLineSymbol)),
                  this._layer.graphics.add(this._activeLineGraphic, 0));
        };
        e.prototype._showFillGraphic = function(b) {
            this._activeFillGraphic
                ? (this._activeFillGraphic.geometry = b)
                : ((this._activeFillGraphic = new u(b, this.activeFillSymbol)),
                  this._layer.add(this._activeFillGraphic));
        };
        e.prototype._showLineGraphic = function(b) {
            this._lineGraphic
                ? (this._lineGraphic.geometry = b)
                : ((this._lineGraphic = new u(b, this.polylineSymbol)),
        ...
        e.prototype._resetCreateOperationGraphics = function() {
            this._activeFillGraphic &&
                (this._activeFillGraphic.geometry = null);
            this._lineGraphic && (this._lineGraphic.geometry = null);
            this._activeLineGraphic &&
                (this._activeLineGraphic.geometry = null);
            this._removeVertexGraphics();
        };
        e.prototype._removeCreateGraphic = function() {
            this.createGraphic &&
                (this._layer.remove(this.createGraphic),
                this._set("createGraphic", null));
        };
        ...
        e.prototype._removeActiveLineGraphic = function() {
            this._activeLineGraphic &&
                (this._layer.remove(this._activeLineGraphic),
                this._activeLineGraphic.destroy(),
                (this._activeLineGraphic = null));
        };
        e.prototype._removeActiveFillGraphic = function() {
            this._activeFillGraphic &&
                (this._layer.remove(this._activeFillGraphic),
                this._activeFillGraphic.destroy(),
                (this._activeFillGraphic = null));
        };
        e.prototype._removeLineGraphic = function() {
            this._lineGraphic &&
        ...
        e.prototype._removeVertexGraphics = function() {
            this._vertexGraphics.length &&
                ...
                this._vertexGraphics.forEach(function(b) {
                    return b.destroy();
                }),
                (this._vertexGraphics = []));
        };
        e.prototype._removeDefaultLayer = function() {
            this._layer &&
        ...
        e.prototype._displayPointerCursor = function() {
            this.view &&
                this.view.container &&
                this.view.container.style &&
        ...
        e.prototype._displayDefaultCursor = function() {
            this.view &&
                this.view.container &&
                this.view.container.style &&
        ...
        e.prototype._logError = function(b, d, a) {
            Q.error(new L(b, d, a));
        };
        e.prototype._emitCreateEvent = function(b) {
            this.emit("create", t({}, b, { type: "create" }));
        };
        e.prototype._emitUpdateEvent = function(b) {
            this.emit("update", t({}, b, { type: "update" }));
        };
        e.prototype._emitResetEvent = function() {
            this.emit("reset", { type: "reset" });
        };
        e.prototype._emitUndoEvent = function(b) {
            this.emit("undo", t({}, b, { type: "undo" }));
        };
        e.prototype._emitRedoEvent = function(b) {
            this.emit("redo", t({}, b, { type: "redo" }));
        };
        q([p.property()], e.prototype, "_operationHandle", void 0);
        q(
            [
                p.property({
                    dependsOn: ["_operationHandle", "_operationHandle.tool"],
                    readOnly: !0
                })
            ],
            e.prototype,
        ...
        q([p.property()], e.prototype, "layer", void 0);
        ...
        q(
            [
                p.property({
                    dependsOn: ["view.ready", "layer", "_operationHandle"],
                    readOnly: !0
                })
            ],
            e.prototype,
        ...
        q([p.property()], e.prototype, "updatePointSymbol", void 0);
        ...
        q([p.property()], e.prototype, "redo", null);
