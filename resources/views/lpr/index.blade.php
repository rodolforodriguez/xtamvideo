...
<script src="<?php echo HOST; ?>/3.27/init.js"></script>
<link rel="stylesheet" href="<?php echo HOST; ?>/3.27/dijit/themes/nihilo/nihilo.css">
<link rel="stylesheet" href="<?php echo HOST; ?>/3.27/esri/css/esri.css">
...
<div data-dojo-type="dijit/layout/BorderContainer" 
      ...
      <div id="map"  style="height: 80vh;min-height: 250px;">
          ...
          <div style="position:absolute; right:20px; top:10px; z-Index:999;">
            <div class="btn btn-success" data-dojo-type="dijit/TitlePane" 
                data-dojo-props="title:'TIPO DE MAPA', open:false">
      ...
      require([
       ...
       ////create Circle
        ...
        function addToMap(evtObj) {
          ...
          //"<iframe style='height: 80vh;min-height: 850px;width: 100%;' src='../vs/Pcampoly.php?userid=<?php //echo $userid; ?>&state=<?php //echo $cliente; ?>&var=(%20"+coordinates+")' style='color:  white;font-size: small;' id='iframe' frameborder='0' allowfullscreen='allowfullscreen'></iframe>";  
        ...
        //$( "#idcam"+cameraid ).click(function() {
         ...
         var myPoint = { 
            ...
            "attributes":{
                ...
                //"Link":'<a href="streaming?ip=<?php //echo $server; ?>&state=<?php //echo $cliente; ?>" >'+
                //         '<?php //echo $channel; ?></a>',
        ...
        var myPoint = {
          ...
          "attributes":{
              ...
              /*"Link":"<form action='../vs/alarm/' method='POST'>" +
                      ...
                      "<input type='hidden' name='state' value=<?php //echo $cliente; ?>>"+
